# Generated by Django 2.2.6 on 2021-07-19 17:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('moderator', 'moderator'), ('admin', 'admin'), ('user', 'user')], default='user', max_length=255)),
                ('bio', models.CharField(blank=True, help_text='Описание', max_length=50, verbose_name='Описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(blank=True, validators=[api.validators.validate_title_year], verbose_name='Год премьеры')),
